...
namespace WordDocument2.ERDS2DataSetTableAdapters {
...
SELECT AccountID, AccountNumber, BankID, DeactivateDate, AccountName FROM Accounts WHERE (AccountID = @AccountID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WordDocument2.Properties.Settings.Default.ERDS2ConnectionString;
        }

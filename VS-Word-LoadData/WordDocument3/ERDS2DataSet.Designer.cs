...
namespace WordDocument3.ERDS2DataSetTableAdapters {
...
SELECT AccountID, AccountNumber, BankID, DeactivateDate, AccountName FROM Accounts WHERE (AccountID = @AccountID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WordDocument3.Properties.Settings.Default.ERDS2ConnectionString;
        }
